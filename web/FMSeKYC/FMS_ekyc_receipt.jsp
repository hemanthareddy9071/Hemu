...
<html lang="en">
    <head>
        <% response.setHeader("Pragma", "no-cache");
            ...
            JSONObject requestPar = (JSONObject) request.getAttribute("CUST_FORM_DATA");
            if (requestPar != null) {
                AppLogger.debug("requestCustFormData" + requestPar);
                //objfrmData = requestPar;
               objfrmData.put("WINGS_ISD", requestPar.getBoolean("WINGS_ISD"));
               objfrmData.put("WINGS_IR", requestPar.getBoolean("WINGS_IR"));
            }
        %>
        <meta charset="utf-8">
...
var takeIsdPayment=true;
            ...
            function fmseKYCJOBUpload() {
                var val=$('#Payment_Status').val();
                 $("#waitConf").show();
                 if(val == 'true' &&  !(takeIsdPayment)){
                try {
                    var reqData = {};
                    reqData.KYCType = "FMSEKYC";
                    reqData.isPaymentDone = val;
                    document.FMSeKYC_receipt.reqData.value = encrypt(JSON.stringify(reqData));
                    document.FMSeKYC_receipt.method = "post";
                    document.FMSeKYC_receipt.action = "uploadJobWithPayment.do";
...
//                    alert(':::::::::::::::Exception in uploadEkyc  method\t' + e);
                ...
                reqData.isPaymentDone = val;
                          $.ajax({
                            url: 'uploadJobAndAcknowlegmentOTP.do',
                            type: 'POST',
                            async: false,
                            dataType: 'json',
    ...
    <body onload="setEKYCPreviewData();">
        <form name="FMSeKYC_receipt">
            ...
            <div id="page_header_bar" class="row" >
                <div class="col-xs-12">
                    <div class="breadcrumtxt"> <span class="bluetxt"></span> 
                        <span class="bluetxt"><a href='#' ><s:text name="ekyc.receipt.nav1"/>  </a></span>       <span class="larrow">&gt;</span> <span class="bluetxt" id="navUploadStatusId"><s:text name="ekyc.receipt.nav2"/> </span></div>
            ...
            <div class="mask" style="display:none" id="waitConf">
                <img src="<%=CSS_JS_PATH%>images/m-wait.gif?ReqParam=<%=CSS_JS_VERSION%>" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label class="col-md-6"><s:text name="ekyc.receipt.custttl"/></label><span id="pre_cust_tilte"></span>       
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <label class="col-md-6"><s:text name="ekyc.receipt.usrcode"/></label><span id="pre_usage_code"></span>       
                        </div>
                        <div class="col-md-4">
                            <label class="col-md-6"><s:text name="ekyc.receipt.pretype"/></label><span id="pre_cust_pre_type"></span>       
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12 pad10T">
                            <div class="" id="payment_pending" > 
                                <a href="#"  data-toggle="modal" class="primarybt" onclick="fmseKYCJOBUpload('false');"><s:text name="ekyc.receipt.confPay"/></a> 
                                <a href='Login.do' class="primarybt1" ><s:text name="ekyc.receipt.cancel"/>  </a>
                            </div>
                            <div class="" style="display: none" id="payment_success" >
                                <a href="#"   data-toggle="modal" class="primarybt" onclick="fmseKYCJOBUpload('true');"><s:text name="ekyc.receipt.confSubmit"/></a><a href='Login.do' class="primarybt1" > <s:text name="ekyc.receipt.cancel"/>  </a>
                            </div>
                        </div>
                    </div>
...
<!--                            <h4 class="mrg10B" style=" color: #008cc7 !important;">Service details </h4>
            ...
            <footer id="footer-bar" class="row" >
                <p id="footer-copyright" class="col-xs-12"> Copyright © 2018 Intense Technologies Limited. All rights reserved. </p>
            </footer>
        </div>
