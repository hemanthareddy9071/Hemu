...
<%
            ...
            objLoginInfo = logInfo;
              AppLogger.debug("request LoginData in attachments page::"+objLoginInfo); 
            }
    ...
    <script >   
         ...
         var dkycfWinghomephone="<s:text name="dkyc.form.wngs.homephone"/>";
          var dkycfWingworkphone="<s:text name="dkyc.form.wngs.Workphone"/>";
           ...
           var imgSizeDKYC="<s:text name="dkyc.form.img.size.int"/>";
    </script>
</head>
    ...
    <div class="row">
      ...
      <div id="content-wrapper">
        <div id="page_header_bar" class="row">
          <div class="col-xs-12">
            <div class="breadcrumtxt"> <span class="bluetxt"><a href="#"> Home </a></span> <span class="larrow">&gt;</span> <span class="bluetxt"> Digital KYC</span></div>
...
<!--                <div class="file_upload btn btn-default">
          ...
          <div class="clear mrg20B"></div>
          <div class="form-group col-md-12 pad20L"> <a onclick="nxtToDKYCForm('DKYC');" class="primarybt" title="Next">Next</a> 
<!--              <a onclick="bckToFlowSelection();" class="secondarybt" title="Back">Back</a>-->
                    <a href="Login.do" class="secondarybt" title="Cancel">Cancel</a>
          </div>
        </div>
                                     ...
                                     if(!(extension.toUpperCase() =='JPEG' || extension.toUpperCase() == 'JPG' ) ){
                                         ...
                                         var iSize = ($("#"+imgId)[0].files[0].size / 1024); 
                                          iSize = (Math.round(iSize * 100) / 100);
                                            if(iSize >imgSizeDKYC)
                                            {
                                               alert(dkycimgSz+ imgSizeDKYC / 1024 +' MB'); 
                                               return false;
                                            }
