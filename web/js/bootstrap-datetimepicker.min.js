    ...
    var c = function(c, d) {
        var e, f, g, h, i, j, k, l = {},
            ...
            E = function() {
                ...
                }).append(a("<span> <b>Set Default Date</b></span>")))), !d.sideBySide && A() && z() && b.push(a("<td>").append(a("<a>").attr({
            ...
            ca = {
                ...
                today: function() {
                   this.date('01-01-1900');
                    this.hide();
                    //these twolines are for bootstrap default today function
//                    var a = x();
//                    Q(a, "d") && _(a)
                },
                close: aa
