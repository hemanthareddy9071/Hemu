        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td align="left" valign="top" style="padding-left:20px;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr><td height="10px"></td></tr>
                                    <tr>
                                        <td nowrap class="data" valign="middle" >*Another user has invalidated your session by logging in with the same/another UserID.</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
            ...
            <tr>
                <td style="color:#E0A21B;font-size:20px;" align="center" valign="top" >
                    <br>
                    <a href="javascript:redirect()" >Click Here To LOGIN Page</a>
                </td>
            </tr>
