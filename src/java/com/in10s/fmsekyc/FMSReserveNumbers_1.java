 ...
 * @author ramu
 */
public class FMSReserveNumbers_1 {
    ...
    public String FMSunReserveCYMNNos() {
        AppLogger.info("starting of FMSunReserveCYMNNos method in FMSReserveNumbers");
        ...
        try {
            ...
            AppLogger.debug("Request data in FMSunReserveCYMNNos method is :  " + strReqData);
...
//            }
            ...
            AppLogger.debug("onBoardURL for FMSunReserveCYMNNos method is : " + serviceURL);
            ...
            AppLogger.debug("Input data  for fetchCYMNNos services in FMSunReserveCYMNNos method is : " + inputFieldsEntity);

            String strJobsCurrentStatus = new CRSClient().OnBoardServiceCall(serviceURL, inputFieldsEntity);
            AppLogger.debug("Response from fetchCYMNNos services in FMSunReserveCYMNNos method is : " + strJobsCurrentStatus);
            ...
            if (CYMNNosObj.containsKey("STATUS")) {
                ...
                System.out.println("::::::::CYMN_SOURCE ::: " + session.getAttribute("CYMN_SOURCE"));
                response.setSuccess(true);
                response.setResponseData(CYMNNosObj);
            } else {
                AppLogger.debug("Status key missing in fetchCYMNNos services repsonse is : " + CYMNNosObj);
